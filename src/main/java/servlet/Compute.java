...
public class Compute extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (sum != null) {
			if (sum.equals("true")) {
				htmlServlet = htmlServlet + "<td> Sum </td>";
				col++;
			}
		}
		if (difference != null) {
			if (difference.equals("true")) {
				htmlServlet = htmlServlet + "<td> Difference </td>";
				col++;
			}
		}
		if (product != null) {
			if (product.equals("true")) {
				htmlServlet = htmlServlet + "<td> Product </td>";
				col++;
			}
		}
		htmlServlet = htmlServlet + "        </tr>\n" + "        <tr>\n" + "          <td>" + firstNumber + "</td>\n"
				+ "          <td>" + secondNumber + "</td>\n";
		if (sum != null) {
			if (sum.equals("true")) {
				htmlServlet = htmlServlet + "<td>" + (Integer.parseInt(firstNumber) + Integer.parseInt(secondNumber))
						+ "</td>";
			}
		}
		if (difference != null) {
